						...
						>
							...
							>
								<p className='font-medium'>
									Delta E: {similarColor.distance?.deltaE2000.toFixed(2)}
								</p>
								<p className='mt-2 leading-relaxed'>
									{similarColor.distance?.deltaE2000 &&
									similarColor.distance?.deltaE2000 < 1
										? 'Не различимо человеческим глазом'
										: similarColor.distance?.deltaE2000 &&
										  similarColor.distance?.deltaE2000 < 2
										? 'Едва заметное различие'
										: similarColor.distance?.deltaE2000 &&
										  similarColor.distance?.deltaE2000 < 3
										? 'Заметное различие при близком рассмотрении'
										: similarColor.distance?.deltaE2000 &&
										  similarColor.distance?.deltaE2000 < 5
										? 'Заметное различие'
										: 'Явное различие'}
								</p>
							</div>
