...
const baseClasses = {
	...
	panel: `mx-auto max-w-4xl w-full rounded-lg p-4 sm:p-6 shadow-xl transition-colors duration-200 max-h-[90vh] overflow-y-auto`,
}
					...
					<form onSubmit={handleSubmit} className='space-y-4 sm:space-y-6'>
						...
						<div className='space-y-4'>
							<div className='flex flex-col sm:flex-row gap-2 sm:gap-4 items-start sm:items-center'>
								<label className={`${labelClasses} text-sm sm:text-base`}>
									Формат цвета:
								</label>
								<div className='flex gap-2'>
									<button
										...
										className={`px-3 py-2 sm:py-1 rounded-md text-sm ${
											colorInputMode === 'hex'
												? isDark
									...
									>
										...
										<div className='space-y-4'>
											...
											<div className='space-y-4'>
												<div className='flex flex-col sm:flex-row gap-2 sm:gap-4 items-start sm:items-center'>
													<label
														className={`${labelClasses} text-sm sm:text-base`}
													>
														Формат цвета:
													</label>
													<div className='flex gap-2'>
