...
import { importPantoneColors } from '../lib/pantoneImport';
            ...
            {user?.isAdmin && (
              <button
                onClick={async () => {
                  if (
                    confirm(
                      'Import Pantone colors? This will replace existing Pantone data.'
                    )
                  ) {
                    const success = await importPantoneColors();
                    if (success) {
                      alert('Pantone colors imported successfully!');
                      loadData();
                    } else {
                      alert('Failed to import Pantone colors.');
                    }
                  }
                }}
